    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=100, choices=[(b'Experience', b'Experience'), (b'Presentation', b'Presentation'), (b'Workshop', b'Workshop'), (b'Publication', b'Publication')])),
